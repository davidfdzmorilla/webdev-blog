...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${slug.replace('-', ' ')} - Category`,
    description: `Browse posts in the ${slug.replace('-', ' ')} category`,
  };
}
...
export default async function CategoryPage({ params, searchParams }: PageProps) {
  ...
  const { posts, total } = await getPostsByCategory(slug, currentPage, 10);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center space-x-3 mb-2">
            ...
            <span className="text-4xl font-bold text-blue-600">{categoryName}</span>
          </div>
